...
export const projects: readonly Project[] = [
  { slug: 'atlas', volumeId: 'vol-01', title: 'A shared language for a growing product', category: 'Design System', role: 'Lead Product Designer', timeline: '12 months', team: 'Design · Product · Engineering', platform: 'Web · Mobile', summary: 'Aligned three product teams around a shared product model and a maintainable design-system foundation.', problem: ['Fast product growth left teams maintaining conflicting patterns, terminology, and interaction logic.', 'The same task behaved differently depending on where a user entered the product.'], solution: ['Defined a shared interaction model before standardising its visual expression.', 'Built foundations and components with explicit extension points for product-specific needs.'], constraints: ['Multiple teams were shipping in parallel.', 'Existing workflows could not pause for migration.', 'Patterns needed to work across web and mobile.'], systemDecisions: [{ id: 'atlas-shared-model', decision: 'Use one shared interaction model with explicit extension points.', rationale: 'Users should not relearn the same task between product areas.', tradeoff: 'Teams gave up some local freedom in exchange for consistency and maintainability.' }], metrics: [{ value: '3', label: 'product teams aligned', source: 'Internal adoption review', verified: false }], visualAssets: [{ id: 'atlas-foundation', media: { src: '/assets/atlas-system.svg', alt: 'Atlas design-system overview', width: 1600, height: 1000, placeholder: '#CBD6FF' }, caption: 'The shared product and component foundation.', spec: 'SYSTEM MAP · V1.4 · WEB + MOBILE' }], reflection: 'The strongest system work happened before the component library: agreeing on the product language made the interface rules much easier to defend.' },
  { slug: 'northstar', volumeId: 'vol-02', title: 'Turning an early idea into a product people could trust', category: 'Zero to One', role: 'Founding Product Designer', timeline: 'Concept to launch', team: 'Founders · Product · Engineering', platform: 'Responsive web', summary: 'Turned an early proposition into a focused product model built around context, confirmation, and user control.', problem: ['The product mixed education, account activity, and transactions without a clear hierarchy.', 'Trust-sensitive decisions arrived before users had enough context to act confidently.'], solution: ['Organised the primary journey around context, confirmation, and control.', 'Used the resolved journey to determine what the dashboard needed to contain.'], constraints: ['The proposition and technical scope were evolving together.', 'Financial decisions required unusually clear states and language.', 'A small team needed patterns it could reuse quickly.'], systemDecisions: [{ id: 'northstar-journey-first', decision: 'Design the primary journey before the dashboard.', rationale: 'The home experience should support a resolved product model rather than become a collection of features.', tradeoff: 'A visually impressive dashboard was delayed while the less visible interaction logic was resolved.' }], metrics: [], visualAssets: [{ id: 'northstar-flow', media: { src: '/assets/northstar-flow.svg', alt: 'Northstar product flow', width: 1600, height: 1000, placeholder: '#FFB99F' }, caption: 'Context and control remain visible throughout the core flow.', spec: 'CORE FLOW · RESPONSIVE WEB · 7 STATES' }], reflection: 'Starting with the journey exposed product questions that a dashboard concept would have hidden. The slower first step made the rest of the product faster to design.' },
]
