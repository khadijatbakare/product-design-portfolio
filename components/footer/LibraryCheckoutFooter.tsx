...
function PostcardLink({ entry }: { readonly entry: LedgerEntry }) {
  ...
  return (
    ...
    >
      <span className="uppercase tracking-wider text-[#625b52]">
        {entry.label}
      </span>
  ...
  return (
    <footer className="theme-checkout flex w-full justify-center bg-[#efebe4] px-4 py-16 transition-[filter] duration-500">
      <section className="relative w-full max-w-4xl overflow-hidden rounded-sm border border-[#ddd6c8] bg-[#faf7f2] p-6 text-[#23201d] shadow-[0_10px_30px_-10px_rgba(0,0,0,.16)] sm:p-10">
        ...
        <header className="relative mb-7 flex items-center justify-between border-b border-[#e8e1d3] pb-4 font-mono text-[10px] uppercase tracking-[.18em] text-[#625b52]">
        ...
        <div className="relative grid gap-9 md:grid-cols-2">
          ...
          <div className="md:pr-6">
            <p className="font-mono text-[10px] uppercase tracking-[.18em] text-[#625b52]">
              Post card
            </p>
                ...
                <div key={entry.id} className="relative">
                  ...
                  {entry.id === "email" && email && (
                    <button
                      ...
                      className="absolute right-0 top-1/2 -translate-y-1/2 bg-[#faf7f2] p-2 text-[#625b52]"
                    >
          ...
          <div className="border-t border-[#e8e1d3] pt-7 md:border-0 md:pl-6 md:pt-0">
            <div className="flex items-start justify-end gap-3">
              <div className="stamp-ink mt-2 rotate-[-4deg] text-center font-mono text-[10px] uppercase text-[#7a2e20]">
              ...
              <div className="flex h-24 w-20 rotate-1 flex-col items-center justify-between border-2 border-dashed border-[#c7beaf] bg-[#faf5ec] p-2 font-mono text-[10px] uppercase text-[#625b52] shadow-inner">
            ...
            <div className="mt-8 border-b border-[#e3dcce] pb-3 font-serif text-xs italic text-[#524d44]">
              <span className="mr-2 font-mono text-[10px] not-italic text-[#625b52]">
                TO:
              </span>
            ...
            <button
              ...
              className="mt-5 w-full border border-[#23201d]/20 px-4 py-2.5 font-mono text-[10px] uppercase tracking-wider"
            >
              View résumé on site →
            </button>
            <a
        ...
        <div className="relative mt-8 flex flex-col justify-between gap-2 border-t border-[#e8e1d3] pt-4 font-mono text-[10px] text-[#625b52] sm:flex-row">
